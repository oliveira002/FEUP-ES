...
import 'package:uni/model/subject_page_model.dart';
...
class ScheduleSlot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      child: getRowContainer(context),
      onTap: () => {
              Navigator.push(
                  context, MaterialPageRoute(builder: (__) 
                  => SubjectPageClass(this.subject,this.subjectID)))
            }
    );
  }
  Widget getRowContainer(BuildContext context){
    return RowContainer(
        child: Container(
      padding:
