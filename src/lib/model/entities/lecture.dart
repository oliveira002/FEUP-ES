...
class Lecture {
  ...
  factory Lecture.fromHtml(
    ...
    return Lecture(subject, subjectID, typeClass, day, blocks, room, teacher,
        classNumber ,
  ...
  static Lecture cloneHtml(Lecture lec) {
    return Lecture.fromHtml(lec.subject,lec.subjectID, lec.typeClass, lec.day,
        lec.startTime,
  ...
  printLecture() {
    Logger().i(subject + ' '+ subjectID +' ' + typeClass);
  ...
  @override
  int get hashCode => hashValues(subject,subjectID, startTime, endTime, typeClass,
      room,
