...
import 'package:uni/controller/schedule_fetcher/subject_fetcher_html.dart';
...
Future<List<SubjectInfo>> getSubectPage(BuildContext context,String subjectID) {
  return SubjectFetcherHtml().getSubectPage(context, subjectID);
}
