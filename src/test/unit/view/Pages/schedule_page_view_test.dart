...
void main() {
  group('ExamsPage', () {
    ...
    final lecture1 = Lecture.fromHtml(subject1,'404', typeClass1, day1,
    ...
    final teacher2 = 'PMMS';
    final day2 = 0;
    final lecture2 = Lecture.fromHtml(subject2,'404', typeClass2, day2,
    ...
    final teacher3 = 'PMMS';
    final day3 = 1;
    final lecture3 = Lecture.fromHtml(subject3,'404', typeClass3, day3,
    ...
    final teacher4 = 'JAS';
    final day4 = 2;
    final lecture4 = Lecture.fromHtml(subject4,'404', typeClass4, day4,
    ...
    final teacher5 = 'SSN';
    final day5 = 3;
    final lecture5 = Lecture.fromHtml(subject5, '404',typeClass5, day5,
    ...
    final teacher6 = 'PMMS';
    final day6 = 4;
    final lecture6 = Lecture.fromHtml(subject6, '404',typeClass6, day6,
